                    ...
                    <div class="dt-buttons btn-group flex-wrap">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="exportData">
                                <a class="dropdown-item" href="#" id="buttons-excel" onclick="exportToExcel()">Excel</a>
                                <a class="dropdown-item" href="#" id="buttons-pdf">PDF</a>
                            </div>
                        </div>
                    </div>
                    <a href="{{ route('coupon.create') }}" class="btn btn-primary float-right" data-placement="left">
                        {{ __('Thêm mới') }}
                    </a>
                                ...
                                <table data-bs-spy="scroll"
                                    ...
                                    @foreach ($coupons as $coupon)
                                        <tr class="even" onmouseover="readListScripts.showTableActions()"
                                            ...
                                            <td>
                                                <form action="{{ route('coupon.destroy', $coupon->CouponID) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="example1_info" role="status" aria-live="polite">
                                    Hiển thị {{ $coupons->firstItem() }} đến {{ $coupons->lastItem() }} trong tổng số {{ $coupons->total() }} bản ghi
                                </div>
                            </div>
                        </div>
                    </div>
