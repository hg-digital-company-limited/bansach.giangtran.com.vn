                                    ...
                                    <div class="thumb-description col-sm-8 text-left float-left">
                                        ...
                                        <div class="price">
                                            ...
                                            <div class="additional-info">
                                                <div>Ngày đặt hàng: <strong>{{ $order->OrderDate }}</strong></div>
                                                <div>Tổng giá trị: <strong>{{ number_format($order->TotalPrice, 0, ',', '.') }} VND</strong></div>
                                                <div>Phí vận chuyển: <strong>{{ number_format($order->ShippingFee, 0, ',', '.') }} VND</strong></div>
                                            </div>
...
.price div:nth-child(2)[style*="color: coral"] {
    color: coral !important;
}

.price div:nth-child(2)[style*="color: yellowgreen"] {
...
.additional-info {
    ...
    line-height: 1.6;
                            ...
                            /* CSS for "Đơn Hàng Của Bạn" section styled as cards */
.sidebar-block.sale.products {
