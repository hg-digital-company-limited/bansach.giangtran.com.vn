    ...
    <main>
        <style>
            .product-thumb .image > a {
                background: linear-gradient(90deg, rgba(2, 0, 36, .39), rgba(0, 0, 0, .5) 1.83%, hsla(0, 0%, 100%, .36) 3.21%, rgba(0, 0, 0, .33) 4.72%, rgba(247, 254, 255, .28) 9.84%, hsla(0, 0%, 100%, 0) 47.85%);
            }
        </style>
                                            ...
                                            <div class="product-thumb">
                                                <div class="image zoom">
                                                    <a href="{{ route('product-detail', $book->BookID) }}">
                                                        <img src="{{ asset($book->Avatar) }}" alt="{{ $book->BookTitle }}" height="501" width="385"/>
                                                        <img src="{{ asset($book->Avatar) }}" alt="{{ $book->BookTitle }}" class="second_image img-responsive" height="501" width="385"/>
                                                    </a>
                                                </div>
                                                <div class="thumb-description">
                                                    <div class="caption">
                                                        <h4 class="product-title text-capitalize">
                                                            <a href="{{ route('product-detail', $book->BookID) }}">{{ $book->BookTitle }}</a>
                                                        </h4>
                                                    </div>
                                                    <div class="rating">
                                                        <div class="product-ratings d-inline-block align-middle">
                                                            @php
                                                                $starRatingHTML = '';
                                                                $star = min($book->AVGRating, 5); // Đảm bảo không vượt quá 5 sao
                                                                for($i = 0; $i < $star; $i++) {
                                                    ...
                                                    <div class="button-wrapper">
                                                        <div class="button-group text-center">
                                                            <button type="button" class="btn btn-primary btn-cart" data-toggle="modal" data-target="#cart-pop"
                                                            ...
                                                            <button type="button" class="btn btn-primary btn-quickview" data-toggle="modal" data-target="#product_view"
                                                                    data-book-name="{{ $book->BookTitle }}"
                                                                    data-book-price="{{ $book->SellingPrice }}"
                                                                    data-book-des="{{ $book->Description }}">
                        ...
                        <div class="row">
                            ...
                            <div class="tabs">
                                <ul class="nav nav-tabs justify-content-center">
                                    <li class="nav-item"><a class="nav-link genre-link active" data-toggle="tab" href="#newest">
                                            <div class="tab-title">Sách mới nhất</div>
                                        </a></li>
                                    <li class="nav-item"><a class="nav-link genre-link" data-toggle="tab" href="#most-viewed">
                                            <div class="tab-title">Xem nhiều nhất</div>
                                        </a></li>
                                    <li class="nav-item"><a class="nav-link genre-link" data-toggle="tab" href="#best-selling">
                                            <div class="tab-title">Bán chạy nhất</div>
                                        </a></li>
                                </ul>
                            </div>
                            <div class="tab-content float-left w-100">
                                <div class="tab-pane active float-left w-100" id="newest" role="tabpanel" aria-labelledby="newest-tab">
                                            ...
                                            @foreach ($randomBooks as $book)
                                                <div class="product-layouts">
                                                    <div class="product-thumb">
                                                        <div class="image zoom">
                                                            <a href="{{ route('product-detail', $book->BookID) }}">
                                                                <img src="{{ $book->Avatar }}" alt="Product Image" height="501" width="385"/>
                                                                <img src="{{ $book->Avatar }}" alt="Product Image" class="second_image img-responsive" height="501" width="385"/>
                                                            </a>
                                                        </div>
                                                        <div class="thumb-description">
                                                            <div class="caption">
